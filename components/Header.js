  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white p-5 shadow-md md:px-10">
      ...
      <div className="flex items-center rounded-full py-2 text-sm text-gray-600 placeholder-gray-400 md:border-2 md:shadow-sm">
        ...
        />
        <SearchIcon className="hidden h-8 cursor-pointer rounded-full bg-red-400 p-2 text-white   transition   duration-150 hover:shadow-xl active:scale-90 md:mx-2 md:inline" />
      </div>
      ...
      <div className="flex items-center justify-end space-x-4 text-gray-500">
        ...
        <div className="space-x2 flex items-center rounded-full border-2 p-2">
